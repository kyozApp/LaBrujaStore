...
const imagenesTarjetaVideo = {
    "NVIDIA GTX 1660": "../img/cotizacion/tarjetaDeVideo/gtx1660.png",
    "AMD RX 570": "../img/labrujastore.png",
    "NVIDIA RTX 3060": "../img/cotizacion/tarjetaDeVideo/rtx3060.png",
    "AMD RX 6600": "../img/cotizacion/tarjetaDeVideo/rx6600.png",
    "NVIDIA RTX 3070": "../img/cotizacion/tarjetaDeVideo/rtx3070.png",
    "AMD RX 6700 XT": "../img/cotizacion/tarjetaDeVideo/rx6700xt.png"
    // Asegúrate de agregar más tarjetas de video según sea necesario
};

// Agregar mensajes de depuración
console.log("Rutas de imágenes de tarjeta de video:", imagenesTarjetaVideo);
console.log("Relaciones de tarjetas de video por procesador:", tarjetasVideoPorProcesador);
