...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function actualizarPrecioTotal() {
        ...
        precioTotalSpan.textContent = 'Precio Total: S/.' + total.toFixed(2);
    }
    ...
    function manejarCambioSelect(selectId, spanId) {
        ...
        select.addEventListener('change', function () {
            ...
            precioSpan.textContent = 'Precio: S/.' + (isNaN(precio) ? 0 : precio.toFixed(2));
            ...
            console.log('Precio ' + selectId + ': S/.' + (isNaN(precio) ? 0 : precio.toFixed(2)));
        });
    }
